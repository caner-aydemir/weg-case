...
function Page() {
  ...
  const { employeeDetails } = useContext<any>(EmployeeContext);
      ...
      <div className="flex flex-col">
        ...
        <div className="sm:w-[80%] xs:w-[90%] gap-x-3 mx-auto flex ">
          ...
          <div className="flex flex-col ">
            ...
            <h2 className=" xs:hidden w-full text-left  my-4 sm:mx-4 xs:pl-4 text-gray-600 dark:text-white lg:text-xl md:text-xl sm:text-xl xs:text-xl font-serif">
